...
//Research
var currentResearchLevel = 1;
var currentResearchLevelString = 'None';
...
var techBonusLand = 0;
var techDescrip = 'Increases Scuare Production';
// Colors
var scuareColor;
...
function setup() {
	...
	settingsButton.position(10, 1300);
...
function shop() {
	...
	textSize(28)
	text('Tech Level:' + currentResearchLevel, 10, 1106);
	text('Next Tech Level: ' + nextResearchLevel, 10, 1136);
	text('Description: ' + techDescrip, 10, 1166);
}
